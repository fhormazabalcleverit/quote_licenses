  ...
  return (
    <div className="min-h-screen bg-[#EEE8F8]">
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 sm:py-12">
        ...
        <div className="grid lg:grid-cols-3 gap-4 lg:gap-6 bg-[#FFFFFF] p-4 sm:p-6 lg:p-10 rounded-2xl lg:rounded-3xl border border-2 border-gray-200 relative -top-24 shadow-lg/30">
          {/* License Selection */}
